# Title: Preparation of coposite indicators for woa survey
# Authors: Sayed Nabizada, Christopher Jarvis, 
# Date created: 21/09/2019
# Date last changed: 21/09/2019
# Purpose: This script is for recoding for the composite indicators in the whole of 
#          of Afghanistan survey data
#          indicators and disaggregations are created elsewhere. 
